...
Ensure you have a C++ compiler (like GCC/G++ via MinGW) installed. If you haven't set it up, refer to the [Main Repository README](../index.md) for the installation guide.
 
1. Open your terminal or command prompt.
2. Navigate to the folder containing the specific program:
```bash
   cd semester_2/assignment-primary
```
3. Compile the code using G++:
```bash
   g++ assignment-p-01.cpp -o program.exe
```
...
2. Navigate to the Python Code directory:
```bash
   cd semester_2/Python/Code
```
