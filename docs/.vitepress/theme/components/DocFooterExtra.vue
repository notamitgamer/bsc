  ...
  <div class="doc-footer-extra">
    ...
    <div class="footer-bottom-bar">
      ...
      <div class="bottom-links">
        ...
        <a href="https://github.com/notamitgamer/bsc" target="_blank" rel="noopener noreferrer">GitHub</a>
      </div>
    </div>
  </div>
</template>
...
/* Decorative divider — plain PNG, fixed colors, no theme dependency.
   Height scales down on narrow screens instead of a fixed crop box,
   so buildings never get cut off on mobile. */
.footer-divider {
  width: 100%;
  opacity: 0.95;
  line-height: 0; /* removes the inline-image baseline gap under the img */
}
.footer-divider-img {
  width: 100%;
  height: auto;      /* scales proportionally, whole scene always visible */
  max-height: 130px;
  object-fit: contain;
  display: block;
}
@media (max-width: 639px) {
  .footer-divider-img {
    max-height: 90px; /* smaller on phones so it doesn't dominate the footer */
  }
}
