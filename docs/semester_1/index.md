...
**Explore More:**
* See active work in [**Semester 2**](https://github.com/notamitgamer/bsc/tree/main/semester_2)
...
| No. | Folder Name | Link |
|---|---|---|
| 1 | Assignment Primary | [Open Folder](assignment-primary/index.md) |
| 2 | Assignment Secondary | [Open Folder](assignment-secondary/index.md) |
| 3 | Eduincs Exam | [Open Folder](eduincs_exam/index.md) |
| 4 | Internal Practice | [Open Folder](internal-practice/index.md) |
| 5 | Khurapati Idea | [Open Folder](khurapati-idea/index.md) |
| 6 | Letusc | [Open Folder](letusc/index.md) |
| 7 | Practice C | [Open Folder](practice-c/index.md) |
| 8 | Temp | [Open Folder](temp/index.md) |
| 9 | Tuition C | [Open Folder](tuition-c/index.md) |
| 10 | R | [Open Folder](R/index.md) |
...
Ensure you have a C compiler (like GCC via MinGW) installed. If you haven't set it up, refer to the [Main Repository README](../index.md) for the installation guide.
