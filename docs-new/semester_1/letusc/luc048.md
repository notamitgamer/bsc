...
[Raw](https://raw.usercontent.amit.is-a.dev/semester_1/letusc/luc048.c){.md-button}  [View on GitHub](https://github.com/notamitgamer/bsc/blob/main/semester_1/letusc/luc048.c){.md-button}
...
??? info "Explain with AI"
    ...
    ```text
        ...
        int main()
        {
            ...
            // Check if a test point P(x, y) lies strictly 
