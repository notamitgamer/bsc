...
By accessing or using this website, you confirm that you have read, understood, and agree to be bound by these Terms of Use.

If you do not agree with any part of these Terms, you must not use or access this website or its content.

---

## Eligibility

By using this website, you confirm that you are capable of understanding and agreeing to these Terms.

---

## Ownership & Project Status

This project is provided publicly for educational and reference purposes.

The author reserves the right to:
- Limit or withdraw access to the project at any time
- Discontinue the project without notice
- Disclaim responsibility for how the project is used

No guarantee is made regarding the long-term availability or maintenance of this project.
...
- Any form of plagiarism, cheating, or misuse is entirely your responsibility
...
Unless otherwise stated, all code is licensed under the MIT License.
...
- No guarantees of correctness, completeness, or reliability
- No warranty of fitness for academic, professional, or production use

You use this website and its content **entirely at your own risk**.
...
While efforts are made to ensure correctness, the content may contain errors or outdated information.
...
Any external platforms (e.g., GitHub, hosting providers) may have their own policies.

---

## Third-Party Services

This website may rely on third-party platforms such as GitHub and hosting providers.

We are not responsible for their services, policies, or availability.
...
Any disputes shall be subject to the exclusive jurisdiction of the **Barasat Court, West Bengal**.
